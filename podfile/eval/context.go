// Package eval implements the Runner-mode PodFile execution engine.
// It walks the full AST (declarations + build logic) and produces
// a BuildResult — the complete Pod creation instruction.
package eval

// BuildResult is the complete output of evaluating a PodFile.
...
// Context holds the runtime state during PodFile evaluation.
type Context struct {
...
// BuiltinFunc is a function callable from PodFile build logic.
