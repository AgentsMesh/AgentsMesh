-- PodFile syntax upgrade: MODE args + Codex Rust version + when mode conditions
--
...
) WHERE slug = 'claude-code' AND podfile_source NOT LIKE '%MODE acp%';
...
UPDATE agents SET podfile_source = REPLACE(
    ...
    E'PROMPT_POSITION prepend',
    E'PROMPT_POSITION prepend\n\nMODE acp "app-server"'
) WHERE slug = 'codex-cli' AND podfile_source NOT LIKE '%MODE acp%';
...
) WHERE slug = 'gemini-cli' AND podfile_source NOT LIKE '%MODE acp%';
...
UPDATE agents SET podfile_source = REPLACE(
    ...
    E'PROMPT_POSITION prepend',
    E'PROMPT_POSITION prepend\n\nMODE acp "acp"'
) WHERE slug = 'opencode' AND podfile_source NOT LIKE '%MODE acp%';
