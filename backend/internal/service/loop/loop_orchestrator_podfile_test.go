...
func TestBuildLoopPodfileLayer_PermissionMode(t *testing.T) {
	o := newTestOrchestrator(nil)
	loop := &loopDomain.Loop{PermissionMode: "bypassPermissions"}

	layer := o.buildLoopPodfileLayer(context.Background(), loop, "")

	assert.Contains(t, layer, `CONFIG permission_mode = "bypassPermissions"`)
}

func TestBuildLoopPodfileLayer_DefaultPermissionMode(t *testing.T) {
	o := newTestOrchestrator(nil)
...
func TestBuildLoopPodfileLayer_CustomPermissionMode(t *testing.T) {
	o := newTestOrchestrator(nil)
...
func TestBuildLoopPodfileLayer_ConfigOverrides(t *testing.T) {
	o := newTestOrchestrator(nil)
...
func TestBuildLoopPodfileLayer_ConfigOverrides_SkipsPermissionMode(t *testing.T) {
	o := newTestOrchestrator(nil)
	overrides := map[string]interface{}{
...
func TestBuildLoopPodfileLayer_Prompt(t *testing.T) {
	o := newTestOrchestrator(nil)
	loop := &loopDomain.Loop{}

	layer := o.buildLoopPodfileLayer(context.Background(), loop, "deploy the app")

	assert.Contains(t, layer, `PROMPT "deploy the app"`)
}

func TestBuildLoopPodfileLayer_PromptEmpty(t *testing.T) {
	o := newTestOrchestrator(nil)
	loop := &loopDomain.Loop{}
...
func TestBuildLoopPodfileLayer_PromptEscaping(t *testing.T) {
	o := newTestOrchestrator(nil)
	loop := &loopDomain.Loop{}

	layer := o.buildLoopPodfileLayer(context.Background(), loop, `say "hello" and use \n newline`)

	assert.Contains(t, layer, `PROMPT "say \"hello\" and use \\n newline"`)
}

func TestBuildLoopPodfileLayer_RepoSlug(t *testing.T) {
	repoID := int64(42)
	mock := &mockRepoQuery{
...
func TestBuildLoopPodfileLayer_Branch(t *testing.T) {
	repoID := int64(42)
...
func TestBuildLoopPodfileLayer_RepoQueryError(t *testing.T) {
	repoID := int64(99)
...
func TestBuildLoopPodfileLayer_NoRepoQuery(t *testing.T) {
	repoID := int64(1)
...
func TestBuildLoopPodfileLayer_FullCombination(t *testing.T) {
	repoID := int64(10)
	branch := "develop"
	...
	layer := o.buildLoopPodfileLayer(context.Background(), loop, "run tests")
