...
func (m *svcMockStorage) Download(_ context.Context, _ string) (io.ReadCloser, error) {
...
// Suppress unused import warnings - these are used by other split test files
var (
	_ = strings.Contains
	_ = time.Second
)
