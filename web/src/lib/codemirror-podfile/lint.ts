/**
 * PodFile lint extension for CodeMirror.
 *
 * Provides real-time syntax error highlighting by validating each line
 * against known PodFile declaration patterns.
 */
...
/**
 * Lint source for PodFile.
 * Checks each non-empty, non-comment line for basic syntax errors.
 */
export function podfileLinter(view: EditorView): Diagnostic[] {
