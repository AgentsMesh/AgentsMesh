/**
 * Completion builders for PodFile autocomplete.
...
import type { PodfileCompletionContext } from "./autocomplete";
...
export function buildAgentCompletions(
  agents: PodfileCompletionContext["agents"]
): Completion[] {
...
export function buildRepoCompletions(
  repos: PodfileCompletionContext["repositories"]
): Completion[] {
...
export function buildCredentialCompletions(
  profiles: PodfileCompletionContext["credentialProfiles"]
): Completion[] {
