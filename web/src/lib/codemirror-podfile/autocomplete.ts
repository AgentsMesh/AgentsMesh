/**
 * PodFile autocomplete extension for CodeMirror.
 *
...
/**
 * Context data for PodFile autocomplete.
 * Provides domain-specific candidates for each keyword.
 */
export interface PodfileCompletionContext {
...
function keywordValueOptions(kw: string, ctx: PodfileCompletionContext): Completion[] {
  switch (kw) {
...
export function podfileCompletion(
  context: PodfileCompletionContext
